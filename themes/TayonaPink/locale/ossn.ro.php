...
ossn_register_languages('ro', array(
	...
	'theme:greenbygreen:extra:newsfeed:link' => '&nbsp;Add a <b><i class="fa fa-bullhorn"></i> News Feed</b> entry to the <b>Links</b> submenu on the left sidebar<br>
		(actually superfluous because the News Feed page can be reached at any time by clicking on the site name or the home icon in the header)',
	...
	'theme:greenbygreen:logo:failed' => 'Logo upload failed',
	'theme:greenbygreen:logo:changed' => 'The changes have been saved',
