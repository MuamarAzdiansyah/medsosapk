...
?>
<div class="ossn-profile container-fluid">
	<div class="row">
    	<div class="col-md-12">
			<div class="<?php echo $class; ?>">
				<div class="top-container">
					...
					<div id='profile-hr-menu' class="profile-hr-menu visible-lg">
						<?php echo ossn_plugin_view('menus/tayona_user_timeline', array('menu_width' => 60)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-md">
						<?php echo ossn_plugin_view('menus/tayona_user_timeline', array('menu_width' => 40)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-sm">
						<?php echo ossn_plugin_view('menus/tayona_user_timeline', array('menu_width' => 25)); ?>
					</div>
					<div id='profile-hr-menu' class="profile-hr-menu visible-xs">
						<?php echo ossn_plugin_view('menus/tayona_user_timeline', array('menu_width' => 1)); ?>
					</div>
