...
?>
        <tr>
            <td>
                ...
                <div class="name"><a href="<?php echo ossn_site_url("u/{$user->username}"); ?>"><?php echo $user->fullname; ?></a><br><span class="tayonapink-user-list-admin-type-<?php echo $user->type; ?>"><?php echo $user->type; ?></span></div>
            </td>
