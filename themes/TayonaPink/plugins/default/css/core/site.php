...
.body-background-image {
	background-image: linear-gradient(161deg, #C73DA0 54%, #C62598 50%);
}

.footer-wrapper {
	width: 100%;
	position: absolute;
        background-color:#C73DA0;
}
...
.topbar {
	background-image: linear-gradient(161deg, #C73DA0 54%, #C62598 50%);	color: #fff;
    height: 48px;
	z-index: 99;
	position: fixed;
	top: 0px;
...
.ossn-loading:after {
  ...
  margin: 8px;
  border-radius: 50%;
  border: 6px solid #C62598;
  border-color: #C62598 transparent #C62598 transparent;
...
.tayona-home-left-contents {
	margin-top: 3%;
	margin-bottom: 20px;
}

.tayona-home-left-contents .logo {
	text-align: center;
}

.tayona-home-left-contents .description {
	font-size: 17px;
	text-transform: uppercase;
	font-weight: bold;
	margin-top: 20px;
...
.tayona-home-left-contents .buttons {
	text-align: center;
	margin-top: 10px;
}
...
#tayona-group-header-menu li ul {
    background: #fff;
    height: auto;
    padding: 0px;
    margin: 0px;
...
#tayona-group-header-menu li:first-child {
    border-left: 1px solid #EEE;
}
#tayona-group-header-menu li {
    float: left;
    padding: 0px;
    border-right: 1px solid #EEE;
}
#tayona-group-header-menu li a {
    background: #fff;
    display: block;
    line-height: 42px;
    margin: 0px;
...
#tayona-group-header-menu > ul > li > a {
    color: #2F4979;
    font-weight: bold;
    height: 44px;
}

#tayona-group-header-menu li > a:hover,
#tayona-group-header-menu ul li:hover > a {
    background: #F6F7F8;
    text-decoration: none;
}
#tayona-group-header-menu li ul {
...
#tayona-group-header-menu li:hover ul {
    display: block;
}
#tayona-group-header-menu li li {
    display: block;
    float: none;
    margin: 0px;
    padding: 0px;
...
#tayona-group-header-menu li:hover li a {
    background: none;
}
#tayona-group-header-menu li ul a {
    display: block;
    height: 35px;
    font-size: 12px;
    font-style: normal;
...
#tayona-group-header-menu li ul a:hover,
#tayona-group-header-menu li ul li:hover > a {
    background: #F6F7F8;
    border: 0px;
    text-decoration: none;
}
#tayona-group-header-menu p {
    clear: left;
}
...
.tayona-login-extended-views {
	margin-bottom: 5px;
}

.tayona-login input.form-control {
	height: 25px !important;
}

.tayona-create-account {
	position: relative;
	z-index: 1;
}

.tayona-profile-extra-menu {
	min-width: 10px;
	margin-left: -124px;
	margin-top: 8px;
}
...
.ossn-chat-tab-titles {
	background-color: #C73DA0 !important;
	border-color: #C62598;
}
    ...
    ********************************/
	...
	footer .ossn-footer-menu a:nth-last-child(2)::after {
		content: "|";
          ...
          /**********************
    	added for tayona group cover
    ************************/
      div#container.ossn-group-cover{
...
/*****************************************
    ...
    ***********************************************/
	...
	#tayona-group-header-menu .dropdown {
		margin-top: 9px;
	}
	#tayona-group-header-menu li > a:hover, #group-header-menu ul li:hover > a {
...
.tayona-mygroups-list-name {
	padding: 0px;
}

.tayona-mygroups-list-owner {
	padding: 0px;
	text-align: right;
}
...
/*****************************************************
		Announcement - changing font color
******************************************************/
div.announcement {
