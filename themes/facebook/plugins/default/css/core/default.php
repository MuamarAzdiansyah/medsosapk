...
.sidebar {
    background-color: #2c3e50; /* Warna latar belakang yang lebih profesional */
    height: 100%; /* Menggunakan tinggi penuh */
    z-index: 1000;
    width: 250px; /* Lebar sidebar ditingkatkan */
    position: fixed; /* Posisi tetap agar tetap terlihat */
    ...
    padding: 15px; /* Padding untuk ruang tambahan */
    box-shadow: 2px 0 10px rgba(0, 0, 0, 0.2); /* Bayangan untuk efek kedalaman */
    transition: margin-left 0.3s ease; /* Transisi saat membuka/menutup sidebar */
}

.sidebar-close {
    transition: margin-left 0.5s ease; /* Transisi saat menutup sidebar */
}

.sidebar-open {
    margin-left: 0; /* Membuka sidebar */
    transition: margin-left 0.5s ease; /* Transisi saat membuka sidebar */
}
...
.newseed-uinfo .name a {
    display: block;
    color: #ecf0f1; /* Warna link terang */
    font-size: 14px; /* Ukuran font yang lebih besar */
    font-weight: bold; /* Bold untuk nama */
}

.sidebar-menu-nav {
    font-family: 'Verdana', sans-serif; /* Font yang bersih */
    font-size: 14px; /* Ukuran font lebih besar */
    font-weight: 300; /* Berat font lebih ringan */
    top: 0;
    width: 100%;
}
...
.sidebar-menu-nav li {
    ...
    padding: 0;
    margin: 0;
    line-height: 40px; /* Tinggi item menu */
    cursor: pointer;
...
.sidebar-menu-nav ul .sub-menu li {
    border: none;
    color: #bdc3c7; /* Warna teks submenu */
    line-height: 28px;
    font-size: 13px;
    margin-left: 0;
}
...
.sidebar-menu-nav li a {
    ...
    font-size: 14px;
    font-weight: bold;
    padding: 10px; /* Padding untuk ruang tambahan */
...
/* Pengaturan margin untuk kontrol daftar pengguna */
.ossn-users-list-item .users-list-controls {
    margin-top: 20px; /* Jarak atas */
}

/* Mengatur jarak antar link di kontrol daftar pengguna */
.ossn-users-list-item .users-list-controls a {
    margin-left: 5px; /* Jarak kiri antar link */
}

/* Mengatur tampilan item pengguna dalam daftar */
.ossn-users-list-item {
    border: 1px solid #E9EAED; /* Warna border */
    border-radius: 8px; /* Membulatkan sudut */
    margin-bottom: 10px; /* Jarak bawah */
    margin-right: -10px; /* Jarak kanan */
    margin-left: -10px; /* Jarak kiri */
    background-color: #ff69b4; /* Warna background item menjadi pink (Hot Pink) */
}
...
/* Mengatur alignment untuk kolom pengguna */
