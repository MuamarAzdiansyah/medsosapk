...
**********************************/
* {
    box-sizing: border-box; /* Menambahkan box-sizing untuk pengaturan yang lebih baik */
    font-family: 'Kanit', sans-serif;
}

body {
    background: linear-gradient(135deg, #f3f4f6, #e2e8f0); /* Gradiasi dari abu-abu muda ke biru muda */
    font-size: 14px;
    color: #333; /* Teks gelap untuk kontras yang baik */
    height: 100%;
    transition: background-color 0.5s ease; /* Animasi saat mengubah warna */
}

.ossn-required {
    color: #e63946; /* Warna merah cerah untuk kesalahan */
    transition: color 0.3s ease; /* Animasi saat hover */
}

.ossn-required:hover {
    color: #d62839; /* Warna merah yang lebih cerah saat hover */
}

.navbar {
    background-color: #ff6f61; /* Warna pink untuk navbar */
    color: white; /* Teks putih untuk kontras yang baik */
    padding: 15px; /* Padding untuk navbar */
    text-align: center; /* Teks di tengah */
}

.navbar a {
    color: white; /* Tautan putih di navbar */
    text-decoration: none; /* Menghilangkan garis bawah */
    margin: 0 15px; /* Spasi antar tautan */
    transition: color 0.3s ease; /* Animasi saat hover */
}

.navbar a:hover {
    color: #ffe66d; /* Warna kuning muda saat hover */
}
...
::-webkit-scrollbar-track {
    background-color: #eaeaea; /* Jalur scrollbar lebih terang */
    border-left: 1px solid #ccc; /* Border untuk scrollbar */
}

::-webkit-scrollbar-thumb {
    background-color: #ff6f61; /* Warna pink untuk scrollbar thumb */
    opacity: 0.8; /* Sedikit transparansi */
    border-radius: 10px; /* Menambahkan sudut membulat */
}

::-webkit-scrollbar-thumb:hover {
    background-color: #ff4b30; /* Warna pink gelap saat hover */
    opacity: 1; /* Hilangkan transparansi saat hover */
}

/* Efek animasi pada elemen */
a {
    color: #ff6f61; /* Warna link sesuai dengan navbar */
    transition: color 0.3s ease; /* Animasi saat hover */
}

a:hover {
    color: #ff4b30; /* Warna lebih gelap saat hover */
}

button {
    background-color: #ff6f61; /* Tombol dengan warna pink */
    border: none;
    color: white;
    padding: 10px 20px;
    text-align: center;
    ...
    font-size: 14px;
    margin: 4px 2px;
    transition: background-color 0.3s ease; /* Animasi pada tombol */
    border-radius: 5px; /* Menambahkan sudut membulat */
}

button:hover {
    background-color: #ff4b30; /* Warna lebih gelap saat hover */
}

/* Media query untuk responsif */
@media (max-width: 767px) {
    body {
        font-size: 12px; /* Mengurangi ukuran font di layar kecil */
    }
}
...
/** didn't we have a minimum page height in gopink? #702 **/
...
.ossn-layout-startup {
	...
	background: url("<?php echo ossn_add_cache_to_url(ossn_theme_url('images/background.jpg'));?>") no-repeat !important;
...
.ossn-wall-item .post-contents p {
	/** Incorrect Hyphenation in the theme GoPink 3.0 #824 **/
...
/********************************************************
      @media for 1360px added by Sepiroth X
*********************************************************/
